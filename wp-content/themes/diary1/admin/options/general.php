...
$options[] = array( "name" => "General",
    ...
    $options[] = array( "name" => "Background",
                        "desc" => "You can set the background image and/or color from <strong>Appearance > <a href='$homeurl/wp-admin/themes.php?page=custom-background'>Background</a></strong>",
                        "type" => "info");
						
	$options[] = array( "name" => "Blog Logo/Title",
                        "desc" => "The logo/title is the blog title set in <strong>Settings > <a href='$homeurl/wp-admin/options-general.php'>General</a></strong>",
                        "type" => "info");
