...
//104. Raw Content Formatter Shortcode
function scd_raw_format($content) {
$new_content = '';
...
add_filter('the_content', 'scd_raw_format', 99);
//USAGE :[raw]Unformatted raw code[/raw]
...
/**
 * Disable Automatic Formatting on Posts Thanks to TheBinaryPenguin, see:
...
if ( !function_exists('content_formatter') ) :
